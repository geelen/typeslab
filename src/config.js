System.config({
  ...
  "bundles": {
    "build": [
      "styles/reset.scss!post-css",
      "styles/variables.scss!post-css",
      "styles/traits/colors.scss!post-css",
      "styles/traits/typography.scss!post-css",
      "styles/traits/layout.scss!post-css",
      "styles/traits/flex.scss!post-css",
      "styles/traits/link.scss!post-css",
      ...
      "lib/components/frame.scss!post-css",
      "lib/components/message-entry.scss!post-css",
      "lib/components/type-selector.scss!post-css",
      "lib/components/color-selector.scss!post-css",
      "lib/colors",
      "lib/components/controls.scss!post-css",
      ...
      "lib/components/share.scss!post-css",
      "npm:whatwg-fetch@0.7.0/fetch",
      "lib/components/output.scss!post-css",
      "npm:flummox@3.5.0",
      "lib/actions/message-actions",
      "lib/stores/message-store",
      "lib/type-pairings",
      "github:JenniferSimonds/FontDetect@master/lib/fontdetect",
      "npm:fkit@0.16.2/src/util",
      "npm:fkit@0.16.2/src/fn",
      "npm:fkit@0.16.2/src/list/base",
      "npm:fkit@0.16.2/src/math",
      "npm:fkit@0.16.2/src/list/sublist",
      "npm:fkit@0.16.2/src/list/map",
      "npm:fkit@0.16.2/src/logic",
      "npm:fkit@0.16.2/src/list/set",
      "npm:fkit@0.16.2/src/list/sort",
      "npm:fkit@0.16.2/src/list/zip",
      "npm:fkit@0.16.2/src/obj",
      "npm:fkit@0.16.2/src/string",
      "npm:webfontloader@1.5.15/webfontloader",
      "lib/stores/fonts-store",
      "lib/actions/colors-actions",
      "lib/stores/colors-store",
      "styles/index",
      "npm:process@0.10.1",
      ...
      "lib/components/message-entry.jsx!jsx",
      "lib/components/type-selector.jsx!jsx",
      "lib/components/color-selector.jsx!jsx",
      "npm:events-browserify@0.0.1",
      "npm:react-canvas@0.0.1/lib/FontUtils",
      "npm:react-canvas@0.0.1/lib/CanvasUtils",
      "npm:react-canvas@0.0.1/lib/layoutNode",
      "npm:react-canvas@0.0.1/lib/Layer",
      "npm:whatwg-fetch@0.7.0",
      "npm:fkit@0.16.2/src/list/fold",
      "npm:fkit@0.16.2/src/list/search",
      ...
      "lib/components/controls.jsx!jsx",
      "github:jspm/nodelibs-events@0.1.0/index",
      "lib/components/share.jsx!jsx",
      ...
      "lib/components/output.jsx!jsx",
      "npm:react@0.13.1/react",
      "lib/components/frame.jsx!jsx",
      "npm:react@0.13.1",
      "lib/app.jsx!jsx",
      "lib/main"
    ]
